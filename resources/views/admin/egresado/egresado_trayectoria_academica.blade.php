...
<form action="{{route('egresado.update', $egresado->matricula)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="modal-view-{{$egresado->matricula}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->matricula}}" disabled> {{--Si no ingresa a la condicion tambien debe cerrarse el input con ">" --}}
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->ap_paterno}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->ap_materno}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->nombres}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->fecha_nacimiento}}" disabled>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->semestre_ingreso}}" disabled>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->semestre_egreso}}" disabled>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->celular}}" disabled>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->pais_origen}}" disabled>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->departamento_origen}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->pais_residencia}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->ciudad_residencia}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->lugar_residencia}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        @else
                        value="{{$egresado->linkedin}}" disabled>
                        @endif
                    </div>
                    <div class="form-group">
                        {{-- <input type="text" class="form-control" id="genero" name="genero" required maxlength="50" value="{{$egresado->genero}}"> --}}
                        <label for="id_academico">Carrera</label>
                        <select name="id_academico" class="form-control" id="id_academico" disabled>
