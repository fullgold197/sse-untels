            ...
            <div class="modal-content" align="left">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="doctorado_grado_academico" name="doctorado_grado_academico" required maxlength="20" @if($errors->any()) {{-- Si existe algun error entonces--}}
                        ...
                        @else
                        value="{{$egresado->doctorado_grado_academico}}" disabled> {{--Si no ingresa a la condicion tambien debe cerrarse el input con ">" --}}
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="doctorado_pais">País</label>
                        <input type="text" class="form-control" id="doctorado_pais" name="doctorado_pais" required maxlength="20" @if($errors->any()) {{-- Si existe algun error entonces--}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="doctorado_institución" name="doctorado_institución" required maxlength="100" @if($errors->any()) {{-- Si existe algun error entonces--}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="doctorado_fecha_inicial" name="doctorado_fecha_inicial" required maxlength="20" @if($errors->any()) {{-- Si existe algun error entonces--}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="doctorado_fecha_final" name="doctorado_fecha_final" required maxlength="20" @if($errors->any()) {{-- Si existe algun error entonces--}}
